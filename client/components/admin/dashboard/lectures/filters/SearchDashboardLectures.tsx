...
const SearchDashboardLectures: React.FC = () => {
  return (
        ...
        >
          {({ value, onChange }) => (
            <SelectWrapper
              ...
              value={value}
              onChange={onChange}
              placeholder="Lectures per page"
              groups={[
                {
                  label: 'Lectures per page',
                  options: [
                    {
                      label: '10',
                      value: '10',
...
export default SearchDashboardLectures;
